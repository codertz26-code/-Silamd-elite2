...
// Thumbnail
const PAIR_THUMB = "https://files.catbox.moe/98k75b.jpeg";
...
silamd({
    nomCom: 'pair',
    alias: ['pair', 'pairing', 'getpair', 'paircode', 'code', 'gencode', 'generate', 'session', 'getsession'],
    reaction: '🔗',
...
┃ 
┃ 📱 *𝙾𝚛 𝚞𝚜𝚎:* ${prefixe}pair 255XXXXXXXXX
┗━━━━━━━━━━━━━━━━━━━━
> © 𝙿𝚘𝚠𝚎𝚛𝚎𝚍 𝚋𝚢 𝚂𝙸𝙻𝙰-𝙼𝙳`,
...
> © 𝙿𝚘𝚠𝚎𝚛𝚎𝚍 𝚋𝚢 𝚂𝙸𝙻𝙰-𝙼𝙳`,
        ...
        console.log("❌ Pair Command Error: " + e);
        await zk.sendMessage(dest, {
            react: { text: "❌", key: ms.key }
        });
