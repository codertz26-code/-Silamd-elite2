...
setInterval(async () => {
    if (conf.AUTO_BIO === "yes") {
        ...
        const bioText = `𝐒𝐈𝐋𝐀 𝐌𝐃 ᴅᴇᴠɪᴄᴇ 📅 ᴅᴀᴛᴇ\n${currentDateTime} \n⏰ᴛɪᴍᴇ`;  // Format the bio text
       ...
       try {
        ...
        zk.ev.on("connection.update", async (con) => {
            ...
            if (connection === "connecting") {
                console.log("ℹ️ SILA MD is connecting...");
            }
            else if (connection === 'open') {
                console.log("✅ SILA MD- Connected to WhatsApp! ☺️");
                console.log("--");
                await (0, baileys_1.delay)(200);
                console.log("------");
                await (0, baileys_1.delay)(300);
                console.log("------------------/-----");
                console.log("SILA MD is Online 🕸\n\n");
                //chargement des commandes 
                console.log("Loading SILA MD Commands ...\n");
